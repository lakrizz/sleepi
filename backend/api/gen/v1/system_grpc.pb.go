...
const (
	SystemService_GetSystemInfo_FullMethodName = "/sleepi.v1.SystemService/GetSystemInfo"
	SystemService_CheckUpdate_FullMethodName   = "/sleepi.v1.SystemService/CheckUpdate"
	SystemService_InstallUpdate_FullMethodName = "/sleepi.v1.SystemService/InstallUpdate"
)
...
func (c *systemServiceClient) InstallUpdate(ctx context.Context, in *InstallUpdateRequest, opts ...grpc.CallOption) (*InstallUpdateResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(InstallUpdateResponse)
	err := c.cc.Invoke(ctx, SystemService_InstallUpdate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSystemServiceServer) InstallUpdate(context.Context, *InstallUpdateRequest) (*InstallUpdateResponse, error) {
...
func _SystemService_InstallUpdate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(InstallUpdateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SystemServiceServer).InstallUpdate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SystemService_InstallUpdate_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SystemServiceServer).InstallUpdate(ctx, req.(*InstallUpdateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SystemService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "sleepi.v1.SystemService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _SystemService_InstallUpdate_Handler,
		},
	},
